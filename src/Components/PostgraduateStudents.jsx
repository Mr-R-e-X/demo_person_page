...
const PostgraduateStudents = () => {
  ...
  return (
    <>
      <div className="flex flex-row justify-between items-center py-4 mt-2 px-2 mx-1 rounded-lg bg-slate-800">
        <h1 className="text-xl text-white font-bold px-3">
          {" "}
...
export default PostgraduateStudents;
